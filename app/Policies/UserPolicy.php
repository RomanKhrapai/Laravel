...
class UserPolicy
{
    ...
    {
        return $user->role->permissions->contains('name', 'user.viewAny');
    }
    ...
    {
        return $user->role->permissions->contains('name', 'user.restore');
    }
    ...
    {
        return $user->role->permissions->contains('name', 'user.forceDelete');
    }
}
